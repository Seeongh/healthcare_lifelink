package mz.hc.service.usermanagement.common.vo;
...
public class SearchVO implements Serializable {
    ...
    // 날짜 검색
    private String searchDate; // yyyy-MM-dd
    private String searchYear; // yyyy
    private String searchMonth; // yyyy-MM

    protected String order_type;
    protected String order;
//    protected String order_type = "user_no"; // 정렬 컬럼
//    protected String order = "desc"; // desc, asc
