	      ...
	      <div class="login_layout">
	      	<form id="command" name="certificationForm" action="/mypage" method="post">
		        <section class="login_box">
		          <div class="login_box__header"><!-- <img src="/images/bufs/logo_bufs_main.png" alt=""> -->헬스케어</div>
		          <div class="login_box__body">
		            <section class="login_box__form">
		              ...
		              <button type="button" class="login_box__form_btn" id="btn_login" onclick="duplicatelogin()" >확인</button>
		              	<!-- <button class="login_btn" type="button" onclick="actionLogin(1);">LMS 사용자 로그인</button> -->
	              		<div class="login_ch">
							<!-- <input type="checkbox" name="checkId" class="form_item_check" id="checkId" onclick="saveid(document.loginForm);" class="st1 hidden">
