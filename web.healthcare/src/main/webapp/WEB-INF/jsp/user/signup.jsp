...
<div class="container_wrap inner">
	<section class="layout_content">
		<div class="content_wrap">
				...
				<!-- <h2 class="content_sub_title">아래 입력창에 빠짐없이 작성해 주세요</h2> -->
				<!-- <div id="toggle_btndiv">
					<button class="login_box__form_btn" onclick="roleClick('1')" style="width: 220px; height: 220px;">사용자</button>
					<button class="login_box__form_btn" onclick="roleClick('2')" style="width: 220px; height: 220px;">보호자</button>
					<button class="login_box__form_btn" onclick="roleClick('3')" style="width: 220px; height: 220px;">담당자</button>
					<button class="login_box__form_btn" onclick="roleClick('4')" style="width: 220px; height: 220px;">관리자</button>
				</div> -->
				<div id="toggle_div">
					<form action="/user/succesSignup" enctype="multipart/form-data" method="post" id="signupForm">
						<section class="data_table">
				          ...
				          <!-- <div class="data_table__row userDiv">
				            ...
				            <div class="data_table__td">
				            	<div id="parentNm"></div>
								<input class="form_item_text" type="hidden" class="" id="guardian" name="guardian" value="">
								<a class="form_item_file__btn01" id="btn_parModal_open" rel="modal:open" href="#parModal"  >보호자 검색</a>
				          		<button class="form_item_file__btn01" id="parModalBtn" type="button" data-toggle="modal" data-target="#parModal">보호자 검색</button>
				            </div>
				          </div>
				          <div class="data_table__row userDiv">
				            ...
				            <div class="data_table__td">
				            	<div id="doctorNm"></div>
								<input class="form_item_text" type="hidden" class="" id="doctorId" name="doctorId" size="50" maxlength="30" hidden="hidden">
								<input class="form_item_text" type="number" class="" id="doctorSeq" name="doctorSeq" size="50" maxlength="30" hidden="hidden">
								<input class="form_item_text" type="hidden" class="" id="doctorNm" name="doctorNm" size="50" maxlength="30" hidden="hidden">
								<input class="form_item_text" type="number" class="" id="doctorDept" name="doctorDept" size="50" maxlength="30" hidden="hidden">
				          		<button type="button"  class="btn_save">담당자 검색</button>
				          		<a class="form_item_file__btn01" id="btn_docModal_open" rel="modal:open" href="#docModal"  >담당자 검색</a>
				          		<button class="form_item_file__btn01" id="docModalBtn" type="button" data-toggle="modal" data-target="#docModal">담당자 검색</button>
				            </div>
				          </div> -->
				          <div class="data_table__row">
			              ...
			              <input type="hidden" class="userRole" name="userRoleFk" >
								<!-- <input class="form_item_text" type="radio" class="userRole" name="userRoleFk" value="2" > 보호자
								<input class="form_item_text" type="radio" class="userRole" name="userRoleFk" value="3" > 사용자 -->
				        </section>
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			          ...
			          <div class="data_table__row">
			            ...
			            <div class="data_table__td">
			            	<form action="">
			            		<input class="form_item_text searchMust" name="doctorNm" id="searchDoctorNm" size="20" maxlength="30" title="담당자 이름">
			            	</form>
			      	...
			      	<input type="hidden" class="form_item_text searchMust" id="newDoctorId" size="20" maxlength="30" title="담당자 아읻디">
			      	<input type="hidden" class="form_item_text searchMust" id="newDoctorSeq" size="20" maxlength="30" title="담당자 일련번호">
			      	<input type="hidden" class="form_item_text searchMust" id="newDoctorNm" size="20" maxlength="30" title="담당자 이름">
			      	<input type="hidden" class="form_item_text searchMust" id="newDoctorDept" size="20" maxlength="30" title="담당자 부서">
			      	<table id="doctorTb">
			      	</table>
			      </div>
			      <div class="button_right_group">
			...
			<div class="modal" id="parModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			      <div class="modal-header">
			        <h5 class="modal-title">보호자 검색</h5>
			      </div>
			      <div class="modal-body">
			      <form id="parentForm">
			        <section class="data_table">
			          <div class="data_table__row">
			            <div class="data_table__th must">이름</div>
			            <div class="data_table__td">
			            	<input class="form_item_text searchMust" name="parentNm" size="20" maxlength="30" title="이름">
			            </div>
			          </div>
			          <div class="data_table__row">
			            <div class="data_table__th must">생년월일</div>
			            <div class="data_table__td">
			            	<input class="form_item_date searchMust" type="date" id="parentBirthEnc" name="parentBirthEnc" size="50" maxlength="10" title="생년월일">
			            </div>
			          </div>
			          <div class="data_table__row">
			            <div class="data_table__th must">연락처</div>
			            <div class="data_table__td">
			            	<input class="form_item_text searchMust" type="tel" id="parentTelNumEnc" name="parentTelNumEnc" size="20" maxlength="11">
			...
			<div class="modal" id="agreeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					...
					<br>
			    <div class="button_right_group">
		    		<!-- <a href="#close-modal" class="btn btn_save" id="guardianSave" ></a> -->
...
<script type="text/javascript">
	...
	/* function roleClick(role){
		$('#toggle_btndiv').attr('hidden',true);
		$('#toggle_div').attr('hidden',false);
		$('input[name="userRoleFk"]').val(role);
		if(role == '3'){
			$('#div_deptNm').show();
			$('#userDiv').hide();
		}else{
...
// 		var arr = $('input[name="guardian"]').val() != '' && $('input[name="guardian"]').val() != null ? JSON.parse($('input[name="guardian"]').val()): ${guardian};
		var oldtf = true;
		var newtf = true;
		var arr = $('#regGuardian').val() != '' && $('#regGuardian').val() != null ? JSON.parse($('#regGuardian').val()): [];
// 		var str =  '<section class="data_table">';
// 		if(parentsArr.length>0){
// 			parentsArr.forEach(function(item){
