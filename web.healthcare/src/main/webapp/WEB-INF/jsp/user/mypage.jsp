	...
	<section class="layout_content">
		<div class="content_wrap">
				...
				<section class="data_table">
		          ...
		          <div class="data_table__row">
		            ...
		            <div class="data_table__td">
		            	<a class="form_item_file__btn01" rel="modal:open" href="#passwdModal" id="passModalBtn">비밀번호 변경</a>
		            	 <!-- data-toggle="modal" data-target="#passwdModal" -->
		            	<!-- <button class="form_item_file__btn01"  id="docModalBtn" type="button" >패스워드 변경</button> -->
		            </div>
		          </div>
		          <div class="data_table__row">
		          ...
		          <%-- <c:if test="${userRoleFk eq '2' }">
			          <div class="data_table__row">
			            <div class="data_table__th ">관리 사용자</div>
			            <div class="data_table__td">
							<c:out value="" />
			            </div>
			          </div>
		          ...
		          <div class="data_table__row">
		            ...
		            <div class="data_table__td">
		            	...
		            	<%-- <select id="bloodType" name="bloodType" disabled="disabled" class="form_item_select">
