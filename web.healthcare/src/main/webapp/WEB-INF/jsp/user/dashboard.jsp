        ...
        <main class="main_wrap sub_wrap">
                ...
                <div class="user_profile">
                  <div class="user_profile__img">
                      ...
                      <c:if test="${userProfile eq null or userProfile eq 'null' }">
                          <img src="../_resource_user/images/common/img_user.png" alt="">
                      </c:if>
                  </div>
          ...
          <div class="flex_row">
            ...
            <section class="flex_item radius_box">
              ...
              <div class="radius_body">
                <p class="chat_txt"><img src="../_resource_user/images/common/img_chat_gpt.png" alt="">가 알려주는 나의 건강상태 <strong class="chat_txt_str">AI 주치의</strong>와 함께하세요.</p>
            ...
            <section class="flex_item radius_box">
              ...
              <div class="radius_body">
                <div class="img_box">
                  ...
                  <img src="../_resource_user/images/common/img_sample001.jpg" alt="">
                  </a>
                </div>
              </div>
            </section>
