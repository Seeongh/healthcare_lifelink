    ...
    <header class="header_wrap">
      <div class="header">
        <div class="main_logo_wrap">
          <h1><a href="/userInfo/userBoardInfo?userinfoId=${UserinfoId}" class="main_logo"><img src="../_resource_user/images/common/main_logo.png" alt="1"></a></h1>
        </div>
          ...
          <ul class="gnb">
            <!-- gnb_link _active 클래스 넣으면 색 바뀜 -->
              ...
              <c:if test="${sessuserRoleFk eq '1'}">
                ...
                <li class="gnb_item">
                  <!-- <a href="/community/listboard?boardUserid=<c:out value="${sessUserNm}" />"  id="header_user_community" class="gnb_link">커뮤니티</a>-->
