package mz.hc.web.login.controller;
...
import mz.hc.web.util.AES256Util;
import mz.hc.web.util.GatewayUtils;
import mz.hc.web.util.JwtTokenUtils;
import mz.hc.web.util.Sha256;
import mz.hc.web.util.ImagesUtil;
...
public class LoginController {
     ...
     */
	@GetMapping("/signin")
	public String singin(HttpServletRequest req, HttpServletResponse res, HttpSession session, @RequestParam Map<String, Object> map, Model model) throws Exception {
	...
	public String singup(HttpServletRequest req, HttpServletResponse res, HttpSession session,@RequestParam Map<String, Object> map, Model model) throws Exception {
		model.addAttribute("uri", req.getRequestURI());
		model.addAttribute("url", req.getRequestURL());
		model.addAttribute("result", model.getAttribute("result"));
		if(session.getAttribute("acToken") == null) {	// 로그인 세션 없음.
	...
	@ResponseBody
	public Map<String, Object> duplicateId(HttpServletRequest req, HttpServletResponse res, Model model, @RequestParam Map<String, Object> param) throws Exception{
	...
	public String succesSignup(HttpServletRequest req, HttpServletResponse res, Model model, @RequestParam Map<String, Object> map,
     ...
     */
	@GetMapping("/logout")
	public String logout(HttpServletRequest req, HttpServletResponse res, Model model, HttpSession session , @RequestParam Map<String, Object> map) throws Exception{
		// 세션 확인(인증 값 존재 여부)
	...
	@ResponseBody
	public Map<String, Object> doctorSearch(@RequestParam Map<String, Object> map) throws Exception, MalformedURLException{
		JSONObject body = new JSONObject();
	...
	@ResponseBody
	public Map<String, Object> parentSearch(@RequestParam Map<String, Object> map) throws Exception, MalformedURLException{
		JSONObject body = new JSONObject();
