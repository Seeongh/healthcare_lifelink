...
public class AIHandleDto {
    String aiRequestQuery; //ai 쿼리
    AIResponseStataus responseStataus; //no_result가 default
    String aiReponse;
    LocalDate receivedResponseDate;

    public String getAIQuery(BioInfoDto bioInfoDto) {
        this.aiRequestQuery = "역할: 사용자들의 바이오 정보로 상태를 파악하고 필요한 진단을 내리는 종합병원전문의.\n"+
                ...
                "(50이 최대 불건강) 인 "+bioInfoDto.ageAvg+"세 "+
    ...
    public void setAiReponse(String aiReponse) {
        this.aiReponse = aiReponse;
        this.responseStataus = AIResponseStataus.RESULT_FOUND;
        this.receivedResponseDate = LocalDate.now();
    }
}
